  ...
  group('Secure Policy Tests', () {
    test('Add then Get String values', () async {
      ...
      await cache.addOrUpdate(
          key: 'aKey', value: value, policy: CachePolicy.secure);
    ...
    test('Update a value returns updated value from Secure Storage', () async {
      ...
      await cache.addOrUpdate(
          key: 'aKey', value: updatedValue, policy: CachePolicy.secure);
    ...
    test(
        ...
        () async {
      await cache.addOrUpdate(
          key: 'aKey', value: 'aString', policy: CachePolicy.secure);
